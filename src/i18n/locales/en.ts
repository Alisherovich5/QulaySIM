const en = {
  ...
  home: {
    hwStep1: 'Pick a plan',
    hwStep2: 'Get the QR code',
    hwStep3: 'Connect',
    howLead: 'Getting online —',
    howAccent: 'three steps.',
    howCta: 'See the plans',
    mockTurkey: 'Türkiye',
    mockUae: 'UAE',
    mockUsa: 'USA',
    mockReady: 'Ready',
  ...
  global: {
    ...
    filterCountryPlaceholder: 'Where are you going? e.g. Turkey',
    filterCountryFound: '{{country}} — included in {{count}} plans',
    filterCountryUnknown: 'No such country found. Try spelling it differently.',
    filterData: 'Data',
    ...
    coverageTitle: 'Countries covered',
    coverageCount: 'Works in {{count}} countries',
    duration: {
      week: 'Up to 7 days',
      twoWeeks: 'Up to 15 days',
      month: 'One month',
      longer: 'Longer',
    },
    title: 'Buy once, use it anywhere in the world',
    titleLead: 'One eSIM',
    titleTrail: 'The whole world',
    searchSubmit: 'Search for a country',
    lead: 'Get online in {{count}} countries.',
    fromPrice: 'and up',
    cta: 'See the plans',
    ...
    reasonTwoText: 'Scan the QR code before you leave. On arrival you only switch data on.',
    reasonThreeTitle: 'Keep your number',
    reasonThreeText: 'Your main SIM stays on for calls; data comes from the eSIM.',
    tableCountries: '{{count}} countries',
    table: {
      choose: 'Choose',
      size: 'Data',
      duration: 'Validity',
    ...
    howThree: 'On arrival, point cellular data at the eSIM. That is all.',
  ...
  checkout: {
    ...
    promoLimitReached: 'This promo code has been used up',
    promoFirstOrderOnly: 'This code is for your first order only',
    promoMinOrder: 'This code applies to orders of {{amount}} or more',
  ...
  account: {
    ...
    dataUsed: 'Data used',
    dataLeft: 'Data left',
    ofTotalUsed: '{{used}} of {{total}} used',
    purchasedOn: 'Bought {{date}}',
    som: 'so‘m',
    unlimited: 'Unlimited',
  ...
  support: {
    ...
    deviceText: 'Find out whether your phone supports eSIM.',
    deviceCta: 'Check',
    guideTitle: 'Installation guide',
    guideText: 'Step by step for iPhone and Android.',
    contactTitle: 'Get in touch',
    faqTitle: 'Frequently asked questions',
    faqNote: 'Find the answer you need here.',
    catGeneral: 'General',
    catSetup: 'Setup',
    catBilling: 'Billing',
    catDevice: 'Device',
  ...
  referral: {
    tab: 'Referrals',
    title: 'Invite a friend, get a reward',
    subtitle:
      'Share your code. When your friend makes their first purchase, you get a discount code.',
    ...
    none: 'Nobody has joined yet — share your link.',
    statusPending: 'pending',
    statusCompleted: 'completed',
    referredBy: 'Invited with code {{code}}',
    earnedLabel: 'You have earned',
    som: 'so‘m',
    earnedHint: '{{count}} people bought.',
    invitedLabel: 'Signed up',
    invitedHint: 'Came through your link',
    boughtLabel: 'Bought',
    boughtHint: 'Only these count towards the money',
    shareTitle: 'Your link',
    shareHint: 'Send this link. Anyone who joins through it counts as yours.',
    copyLink: 'Copy link',
    orCode: 'Or by code:',
    peopleTitle: 'People who came through your link',
    waiting: 'has not signed up yet',
    ...
    notYetBought: 'Nobody has bought yet. Your commission is added after the first purchase.',
    rateTitle: 'Your current rate',
    rateHintPercent: 'of every purchase',
    rateHintFlat: 'for every customer who buys',
  ...
  guides: {
    ...
    install: {
      ...
      shot1: '1. Settings → Cellular',
      shot2: '2. Tap “Add eSIM”',
      shot3: '3. “Use QR Code”, then scan it',
      shot4: '4. Name the line and pick your data SIM',
      screenLabel: 'Line settings',
      rowLabel: 'Label',
      rowCalls: 'Calls',
      rowData: 'Cellular Data',
      primary: 'Primary',
      on: 'On',
