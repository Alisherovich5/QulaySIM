const en = {
  ...
  referral: {
    ...
    som: 'so‘m',
    earnedHint: '{{count}} people bought, {{rate}} so‘m for each.',
    ...
    startSubtitle: 'When someone joins through your link and buys an eSIM, you get {{rate}} so‘m. No cap — the more people you bring, the more you earn.',
    step1: 'Send your link to friends or clients.',
    step2: 'They join through it and buy an eSIM.',
    step3: 'You earn {{rate}} so‘m for every person who buys.',
    notYetBought: 'Nobody has bought yet. {{rate}} so‘m is added after the first purchase.',
