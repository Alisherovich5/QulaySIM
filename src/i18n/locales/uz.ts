...
const uz: Translation = {
  ...
  referral: {
    ...
    som: 'so‘m',
    earnedHint: '{{count}} ta odam sotib oldi, har biri uchun {{rate}} so‘m.',
    ...
    startSubtitle: 'Havolangiz orqali kirgan odam eSIM sotib olsa, sizga {{rate}} so‘m tegadi. Cheklov yo‘q — nechta odam olib kelsangiz, shuncha.',
    step1: 'Havolangizni do‘stlaringizga yoki mijozlaringizga yuboring.',
    step2: 'Ular o‘sha havola orqali kirib, eSIM sotib olishadi.',
    step3: 'Har bir sotib olgan odam uchun {{rate}} so‘m yig‘iladi.',
    notYetBought: 'Hali hech kim sotib olmagan. Birinchi xariddan keyin {{rate}} so‘m qo‘shiladi.',
