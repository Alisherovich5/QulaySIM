...
const uz: Translation = {
  ...
  home: {
    hwStep1: 'Tarifni tanlang',
    hwStep2: 'QR-kodni oling',
    hwStep3: 'Ulaning',
    howLead: 'Ulanish —',
    howAccent: 'uch qadam.',
    howCta: 'Tariflarni ko‘rish',
    mockTurkey: 'Turkiya',
    mockUae: 'BAA',
    mockUsa: 'AQSH',
    mockReady: 'Tayyor',
  ...
  global: {
    ...
    checkNo: '{{country}} global tarifga kirmaydi',
    checkNoHint: 'Bu davlat uchun alohida tarif bor — u odatda arzonroq tushadi.',
    checkNoCta: '{{country}} tariflarini ko‘rish',
    checkHint: '167 ta davlatdan istalganini yozing — qamrovni shu yerda tekshiring.',
    ...
    filterCountryPlaceholder: 'Qaysi davlatga borasiz? Masalan: Turkiya',
    filterCountryFound: '{{country}} — {{count}} ta tarifda bor',
    filterCountryUnknown: 'Bunday davlat topilmadi. Nomini boshqacha yozib ko‘ring.',
    filterData: 'Hajmi',
    filterDuration: 'Muddati',
    filterSort: 'Tartib',
    filterAll: 'Hammasi',
    ...
    coverageTitle: 'Qamrab olingan davlatlar',
    coverageCount: '{{count}} ta davlatda ishlaydi',
    duration: {
      week: '7 kungacha',
      twoWeeks: '15 kungacha',
      month: '1 oy',
      longer: 'Uzoqroq',
    },
    title: 'Bir marta oling, butun dunyoda ishlatavering',
    titleLead: 'Bitta eSIM',
    titleTrail: 'Butun dunyo',
    searchSubmit: 'Davlatni qidirish',
    lead: '{{count}} ta davlatda internetdan foydalaning.',
    fromPrice: 'dan',
    ...
    table: {
      ...
      day: 'kun',
      days: '{{count}} kun',
      sortHint: 'Ustun sarlavhasini bosib saralang.',
    },
  ...
  destinations: {
    ...
    tabCountries: 'Davlatlar',
    tabRegions: 'Mintaqalar',
    tabGlobal: 'Global',
    searchCountry: 'Davlatni qidiring',
    fromPrice: '{{price}}dan',
  ...
  support: {
    ...
    deviceText: 'Telefoningiz eSIM‘ga mosligini bilib oling.',
    deviceCta: 'Tekshirish',
    guideTitle: 'O‘rnatish qo‘llanmasi',
    guideText: 'iPhone va Android uchun bosqichma-bosqich.',
    contactTitle: 'Biz bilan bog‘laning',
    faqTitle: 'Ko‘p so‘raladigan savollar',
    faqNote: 'Kerakli javobni shu yerdan toping.',
    catGeneral: 'Umumiy',
    catSetup: 'O‘rnatish',
    catBilling: 'To‘lov',
    catDevice: 'Qurilma',
  ...
  referral: {
    ...
    none: 'Hozircha hech kim kirmagan — havolangizni ulashing.',
    statusPending: 'kutilmoqda',
    statusCompleted: 'yakunlangan',
    referredBy: '{{code}} kodi bilan taklif qilingan',
    earnedLabel: 'Sizga tegishli',
    som: 'so‘m',
    earnedHint: '{{count}} ta odam sotib oldi.',
    invitedLabel: 'Ro‘yxatdan o‘tdi',
    invitedHint: 'Havolangiz orqali kirganlar',
    boughtLabel: 'Sotib oldi',
    boughtHint: 'Pul faqat shulardan hisoblanadi',
    shareTitle: 'Havolangiz',
    shareHint: 'Shu havolani yuboring. U orqali kirgan odam sizniki hisoblanadi.',
    copyLink: 'Havolani nusxalash',
    orCode: 'Yoki kod bilan:',
    peopleTitle: 'Havolangiz orqali kelganlar',
    waiting: 'hali ro‘yxatdan o‘tmagan',
    ...
    notYetBought: 'Hali hech kim sotib olmagan. Birinchi xariddan keyin haq qo‘shiladi.',
    rateTitle: 'Hozirgi stavkangiz',
    rateHintPercent: 'har bir xarid summasidan',
    rateHintFlat: 'har bir sotib olgan mijoz uchun',
    nextRate: 'Yana {{needed}} ta mijozdan keyin stavka {{rate}} ga ko‘tariladi.',
    topRate: 'Bu — eng yuqori stavka.',
    withdrawTitle: 'Pulni yechish',
    withdrawReady: '{{amount}} so‘m yechishga tayyor. Telegramda yozing — kartangizga o‘tkazamiz.',
    withdrawLater: 'Pul yig‘ilgach, Telegramda yozasiz va kartangizga o‘tkazamiz.',
    withdrawButton: 'Telegramda yozish',
  },
  notFound: {
  ...
  seo: {
    ...
    homeTitle: 'eSIM O‘zbekistondan — 200+ davlatga internet',
    homeDescription:
