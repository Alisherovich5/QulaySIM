...
i18n
  ...
  .init({
    ...
    resources: {
      ...
      // boshida yozilgan.
      en: { translation: { ...en, ...ESIM_STATUS_COPY.en, ...DEVICE_CHECK_COPY.en } },
      ru: { translation: { ...ru, ...ESIM_STATUS_COPY.ru, ...DEVICE_CHECK_COPY.ru } },
      uz: { translation: { ...uz, ...ESIM_STATUS_COPY.uz, ...DEVICE_CHECK_COPY.uz } },
    },
